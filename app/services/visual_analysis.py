    ...
    with TemporaryDirectory(prefix="launchify-vision-") as temp_dir_name:
        ...
        for scene, scene_range in zip(launch_script.scenes, scene_ranges, strict=True):
            ...
            extracted_frames = extract_frames_for_scene(
                ...
                scene_range,
                scene_output_dir,
                frame_budget=get_settings().visual_analysis_frames_per_scene,
                frame_width=get_settings().visual_analysis_frame_width,
                jpeg_quality=get_settings().visual_analysis_jpeg_quality,
            )
            analyses.append(
